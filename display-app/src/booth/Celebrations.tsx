/**
 * Celebrations — booth binding of the shared Celebrations overlay (SC2).
 *
 * The canvas/banner engine lives in `@shared/display/Celebrations`; this binds
 * the booth's `ent-` class scheme and its confetti policy: kind-aware budget
 * (Bell 100 / GHZ 150) with a `?lowpower` cap of 60 for the Pi 4, and a
